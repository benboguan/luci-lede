...
elseif (tonumber(m.hidden.wpa_version) or 0) > 0 and
	(m.hidden.wpa_suites == "PSK" or m.hidden.wpa_suites == "PSK2" or m.hidden.wpa_suites == "SAE" or m.hidden.wpa_suites == "WPA3" or m.hidden.wpa_suites == "OWE")
then
...
function newnet.parse(self, section)
	...
	elseif (tonumber(m.hidden.wpa_version) or 0) > 0 then
		wconf.encryption = (tonumber(m.hidden.wpa_version) or 0) >= 2 and "sae" or "wpa3" or "owe" or "psk2" or "psk"
